...
// tables
export * from './tables/GodownStockAvailability/TablesWidget1'
export * from './tables/GodownStockInwards/TablesWidget2'
export * from './tables/OfficeOldStockAvailability/TablesWidget3'
export * from './tables/OfficeOldStockOutwards/TablesWidget4'
export * from './tables/OfficeOldStockInwards/TablesWidget5'
export * from './tables/OfficeStockAvailability/TablesWidget6'
export * from './tables/OfficeStockOutwards/TablesWidget7'
export * from './tables/OfficeStockInwards/TablesWidget8'
export * from './tables/Inquiries/TablesWidget9'
export * from './tables/Installation/TablesWidget10'
export * from './tables/Forms/TablesWidget11'
