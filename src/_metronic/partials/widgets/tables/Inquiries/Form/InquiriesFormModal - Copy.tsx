...
let validationSchemaNewForm = Yup.object({
  ...
  userId: Yup.number().when('statusId' , {
    is: (statusId: any,username:any) => (statusId == 4 && username =='') || statusId == 5,
    ...
    <>
      <Formik
        ...
        onSubmit={async (values: any, { resetForm }) => {
          ...
          console.log("gg",values.statusId);
          
          if (values.statusId == 4) {
          ...
          <>
            ...
            >
              ...
              <div className='modal-footer border-0 pb-0 pt-0'>
                ...
                {(props.values.statusId == '2' && itemIdForUpdate != 'add') ?
