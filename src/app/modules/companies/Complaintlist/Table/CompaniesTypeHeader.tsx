...
const CompaniesTypeHeader = () => {
  const {setItemIdForUpdate, setFilterShow,setPageNo, filterShow, setSearchText,searchText,fetchAllCompanies} = ListPageData()
      ...
      <div className='card-title d-flex align-items-center justify-content-between w-100 mx-0'>
        ...
        <div className='d-flex justify-content-end ms-3' data-kt-user-table-toolbar='base'>
          <div title='Click to add new category'>
            <button type='button' className='btn btn-sm btn-flex btn-light btn-active-primary fw-bold' onClick={openAddCategoryModal}>
...
export default CompaniesTypeHeader
