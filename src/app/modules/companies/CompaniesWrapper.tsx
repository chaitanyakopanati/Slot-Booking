...
import CompaniesFooter from './Complaintlist/Table/CompaniesFooter'
...
import CompaniesView from './Complaintlist/Table/CompaniesView'
  ...
  return (
    <div className='overflow-hidden'>
      <KTCard className='ms-5 me-5'>
        <CompaniesTypeHeader /> {/* begin::  header functionlity */}
        <CompaniesTable /> {/* begin::  Table */}
      </KTCard>
      <CompaniesFooter /> {/* begin::  Footer */}
      {itemIdForUpdate !== undefined && <CompaniesFormWrapper />}{' '}
      {/* begin::  ComplaintFormWrapper*/}
      {viewIdForUpdate && <CompaniesView category={viewIdForUpdate} />}{' '}
      {/* begin::  ViewComplaint*/}
    </div>
  )
}
...
//                       </td>
//                       <td>
//                         <div className='text-dark fw-bold  fs-6'>Earth</div>
//                       </td>
...
//                       </td>
//                       <td>
//                         <div className='text-dark fw-bold  fs-6'>Softnet</div>
//                       </td>
//                       <td className='text-dark fw-bold fs-6'>21-Jun-2020 04:57 PM</td>
//                       <td>
//                         <a
