                ...
                <div className='row w-100 mx-0 my-5'>
                  <div className='col-lg-3'>
                    ...
                    <select className='form-select form-select-solid'>
                      ...
                      <option value='2'>Client PC issue</option>
                      <option value='3'>General issue</option>
                      <option value='4'>Line issue</option>
                    </select>
                  </div>
                  <div className='col-lg-3'>
                ...
                <table className='table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3 table-rounded border table-striped'>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div className='text-dark fw-bold  fs-6'>Saerfing</div>
                      </td>
                      <td className='text-dark fw-bold  fs-6'>Line issue</td>
                      <td className='text-dark fw-bold fs-6'>20-Oct-2021 03:09 PM</td>
                      <td>
                        <a
                          href='#'
                    ...
                    <tr>
                      ...
                      <td>
                        <div className='text-dark fw-bold  fs-6'>Removed material</div>
                      </td>
                      <td className='text-dark fw-bold  fs-6'>Line issue</td>
                      <td className='text-dark fw-bold fs-6'>21-Jun-2020 07:31 PM</td>
                      <td>
                        <a
                          href='#'
                          className='btn btn-icon btn-bg-light btn-active-color-success btn-sm me-1'
                    ...
                    <tr>
                      ...
                      <td>
                        <div className='text-dark fw-bold  fs-6'>Point problem</div>
                      </td>
                      <td className='text-dark fw-bold  fs-6'>Line issue</td>
                      <td className='text-dark fw-bold fs-6'>21-Jun-2020 07:31 PM</td>
                      <td>
              ...
              <div className='modal-dialog modal-dialog-centered'>
                <div className='modal-content'>
                  <div className='modal-header'>
                    <h5 className='modal-title'>Create fault</h5>
                    <div
                    ...
                    <div className='container-fluid p-0'>
                      ...
                      <div className='row w-100 mx-0 mb-4 gy-4'>
                        <div className='col'>
                          ...
                          <select className='form-select form-select-solid'>
                            <option value="1">All</option>
                            <option value="2">Line issue</option>
                            <option value="3">client PC issue</option>
                          </select>
                        </div>
                      </div>
                    </div>
              ...
              <div className='modal-dialog modal-dialog-centered'>
                <div className='modal-content'>
                  <div className='modal-header'>
                    ...
                    <h5 className='modal-title'>Edit fault</h5>
                    <div
                ...
                <div className='modal-content'>
                  <div className='modal-header'>
                    <div className='d-flex align-items-center'>
                      ...
                      <h5 className='modal-title'>View fault</h5>
                    </div>
                    <div className='ms-3'>
                      <a
                        href='#'
