...
const FaultsTypeHeader = () =>{

    const {setItemIdForUpdate, setFilterShow, filterShow, setPageNo,setSearchText,searchText,fetchAllFault} = ListPageData()
...
export default FaultsTypeHeader