...
import BankTypeHeader from '../banks/Complaintlist/Table/BankTypeHeader'
import BankFooter from './Complaintlist/Table/PackagesFooter'
import PackagesView from './Complaintlist/Table/PackagesView'
import PackageTable from './Complaintlist/Table/PackageTable'
import BankFormWrapper from './Form/PackagesFormWrapper'
  ...
  return (
    <div className='overflow-hidden'>
      <KTCard className='ms-5 me-5'>
        <BankTypeHeader /> {/* begin::  header functionlity */}
        <PackageTable /> {/* begin::  Table */}
      </KTCard>
      <BankFooter /> {/* begin::  Footer */}
      {itemIdForUpdate !== undefined && <BankFormWrapper />}{' '}
      {/* begin::  ComplaintFormWrapper*/}
      {viewIdForUpdate && <PackagesView category={viewIdForUpdate} />}{' '}
      {/* begin::  ViewComplaint*/}
    </div>
  )
}
...
//                         </span>
//                       </div>
//                       <h5 className='modal-title'>View package</h5>
//                     </div>
//                     <div className='ms-3'>
//                       <a
//                         href='#'
