...
const PackagesTypeHeader = () => {
  const {setItemIdForUpdate, setFilterShow,setPageNo, filterShow, setSearchText,searchText,fetchAllBank} = ListPageData()
...
export default PackagesTypeHeader
