                ...
                <div className='row w-100 mx-0 my-5'>
                  <div className='col-lg-3'>
                    ...
                    <select className='form-select form-select-solid'>
                      ...
                      <option value='3'>Varachha</option>
                ...
                <table className='table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3 table-rounded border table-striped'>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div className='text-dark fw-bold  fs-6'>Ka_rjd</div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className='text-dark fw-bold  fs-6'>Ka_eva-amro</div>
                      </td>
                      <td className='text-dark fw-bold  fs-6'>Katargam</td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className='text-dark fw-bold  fs-6'>Ka_anjani</div>
                      </td>
                      <td className='text-dark fw-bold  fs-6'>Katargam</td>
                      <td className='text-dark fw-bold fs-6'>21-Jun-2020 07:31 PM</td>
                      <td>
              ...
              <div className='modal-dialog modal-dialog-centered'>
                <div className='modal-content'>
                  <div className='modal-header'>
                    <h5 className='modal-title'>Create main point</h5>
                    <div
              ...
              <div className='modal-dialog modal-dialog-centered'>
                <div className='modal-content'>
                  <div className='modal-header'>
                    ...
                    <h5 className='modal-title'>Edit main point</h5>
                    <div
