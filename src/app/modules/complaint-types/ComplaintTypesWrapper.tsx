      ...
      <div className='row gy-5 gx-xl-8'>
        <div className='col-xl-12'>
          ...
          <div className='card card-xxl-stretch mb-5 mb-xl-8'>
              ...
              <div className='card-title d-flex align-items-center justify-content-between w-100 mx-0'>
                ...
                <div className='ms-3'>
                  <a
                    ...
                    data-bs-target='#create-complaint-type-modal'
                  >
                    <span className='svg-icon svg-icon-gray-500 me-1'>
                      ...
                      <td>
                        <div className='d-flex align-items-center'>
                          ...
                          <div className='d-flex justify-content-start flex-column'>
                            <div className='text-dark fw-bold  fs-6'>Pc issue</div>
                          </div>
                        </div>
                      </td>
                      <td className='text-dark fw-bold  fs-6'>1 Hour</td>
                      <td className='text-dark fw-bold fs-6'>02-Jan-2021 06:19 PM</td>
                      <td>
                        <a
                          href='#'
                          className='btn btn-icon btn-bg-light btn-active-color-success btn-sm me-1'
                          data-bs-toggle='modal'
                          data-bs-target='#view-complaint-type-modal'
                        >
                        ...
                        <a
                          ...
                          data-bs-toggle='modal'
                          data-bs-target='#edit-complaint-type-modal'
                        >
                    ...
                    <tr>
                      ...
                      <td>
                        <div className='d-flex align-items-center'>
                          ...
                          <div className='d-flex justify-content-start flex-column'>
                            <div className='text-dark fw-bold  fs-6'>Connect-disconnect</div>
                          </div>
                        </div>
                      </td>
                      <td className='text-dark fw-bold  fs-6'>4 Hour</td>
                      <td className='text-dark fw-bold fs-6'>03-Sep-2020 10:02 AM</td>
                      <td>
                        <a
                          href='#'
                          className='btn btn-icon btn-bg-light btn-active-color-success btn-sm me-1'
                    ...
                    <tr>
                      ...
                      <td>
                        <div className='d-flex align-items-center'>
                          ...
                          <div className='d-flex justify-content-start flex-column'>
                            <div className='text-dark fw-bold  fs-6'>New installation</div>
                          </div>
                        </div>
                      </td>
                      <td className='text-dark fw-bold  fs-6'>ganesh</td>
                      <td className='text-dark fw-bold fs-6'>27-Jun-2020 05:58 PM</td>
                      <td>
                        <a
                          href='#'
                          className='btn btn-icon btn-bg-light btn-active-color-success btn-sm me-1'
            ...
            {/* begin::create Modal */}
            <div className='modal fade' id='create-complaint-type-modal'>
              <div className='modal-dialog modal-dialog-centered'>
                <div className='modal-content'>
                  <div className='modal-header'>
                    <h5 className='modal-title'>Create complaint type</h5>
                    <div
                  ...
                  <div className='modal-body'>
                    <div className='container-fluid p-0'>
                      ...
                      <div className='row w-100 mx-0 mb-4 gy-4'>
                        <div className='col'>
                          <label className='form-label fw-bold'>ETR</label>
            ...
            <div className='modal fade' id='edit-complaint-type-modal'>
              <div className='modal-dialog modal-dialog-centered'>
                <div className='modal-content'>
                  <div className='modal-header'>

                    <h5 className='modal-title'>Edit complaint type</h5>
                    <div
            ...
            {/* Edit complaint-type::Modal */}
            {/* View complaint-type::Modal */}
            <div className='modal fade' id='view-complaint-type-modal'>
                ...
                <div className='modal-content'>
                  <div className='modal-header'>
                    <div className='d-flex align-items-center'>
                      ...
                      <h5 className='modal-title'>View complaint type</h5>
                    </div>
                    <div className='ms-3'>
                      <a
                        href='#'
