                ...
                <table className='table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3 table-rounded border table-striped'>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div className='text-dark fw-bold  fs-6'>	Varachha</div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className='text-dark fw-bold  fs-6'>Ring road</div>
                      </td>
                      <td className='text-dark fw-bold fs-6'>21-Jun-2020 04:57 PM</td>
                      <td>
                        <a
                    ...
                    <tr>
                      ...
                      <td>
                        <div className='text-dark fw-bold  fs-6'>Katargam</div>
                      </td>
                      <td className='text-dark fw-bold fs-6'>21-Jun-2020 04:57 PM</td>
                      <td>
                        <a
              ...
              <div className='modal-dialog modal-dialog-centered'>
                <div className='modal-content'>
                  <div className='modal-header'>
                    <h5 className='modal-title'>Create zone</h5>
                    <div
