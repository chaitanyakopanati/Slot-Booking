...
const ZonesTypeHeader = () => {
  const {setItemIdForUpdate, setFilterShow,setPageNo, filterShow, setSearchText,searchText,fetchAllZone} = ListPageData()
...
export default ZonesTypeHeader
