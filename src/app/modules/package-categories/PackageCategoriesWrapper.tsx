                ...
                <table className='table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3 table-rounded border table-striped'>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div className='text-dark fw-bold  fs-6'>	Cancel</div>
                      </td>
                      <td>
                        <div className='text-dark fw-bold  fs-6'>1 Hour</div>
                      </td>
              ...
              <div className='modal-dialog modal-dialog-centered'>
                <div className='modal-content'>
                  <div className='modal-header'>
                    <h5 className='modal-title'>Create package category</h5>
                    <div
                  ...
                  <div className='modal-body'>
                    <div className='container-fluid p-0'>
                      <div className='row w-100 mx-0 mb-4 gy-4'>
                        ...
                        <div className='row w-100 mx-0 mb-4 gy-4'>
                          <div className='col'>
                            <label className='form-label fw-bold'>ETR (Hours)</label>
                            <input
                              className='form-control form-control-lg form-control-solid'
                              type='text'
                              autoComplete='off'
              ...
              <div className='modal-dialog modal-dialog-centered'>
                <div className='modal-content'>
                  <div className='modal-header'>
                    ...
                    <h5 className='modal-title'>Edit package category</h5>
                    <div
