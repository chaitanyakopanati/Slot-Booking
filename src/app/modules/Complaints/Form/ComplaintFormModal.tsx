          ...
          <div className=''>
                ...
                <div className='row w-100 mx-0 mb-4 gy-4'>
                  ...
                  <div className='col-lg-6'>
                    ...
                    <div data-select2-id='select-role'>
                      <select className='form-select form-select-solid'   {...formik.getFieldProps('complainttypeid')}>
                ...
                <div className='row w-100 mx-0 mb-4 gy-4'>
                  <div className='col-lg-4'>
                    ...
                    <div data-select2-id='select-zone'>
                      <select className='form-select form-select-solid'  {...formik.getFieldProps('assigntechnicianid')}>
                  ...
                  <div className='col-lg-4'>
                    <div data-select2-id='select-zone'>
                      ...
                      <div data-select2-id='select-zone'>
                        <select className='form-select form-select-solid' {...formik.getFieldProps('status')}>
                  ...
                  <div className='col-lg-4'>
                    <div data-select2-id='select-role'>
                      ...
                      <div data-select2-id='select-role'>
                        <select className='form-select form-select-solid' {...formik.getFieldProps('faultid')}>
                  ...
                  <div className='col-lg-12'>
                    ...
                    <div className='form-check form-switch form-check-custom form-check-solid me-10'>
                      <input
                        ...
                        onBlur={formik.handleBlur}
                        // value=''
                        checked={formik.values.assigntechnicianid !== '' ? true : false}
            ...
            <div className='modal-footer'>
              ...
              <CustomTooltip title='Close form'>
                <button type='reset' onClick={() => navigate('/complaint')} className='btn btn-light'>
                  Close
                </button>
              </CustomTooltip>
